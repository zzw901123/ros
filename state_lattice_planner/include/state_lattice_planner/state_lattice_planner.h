...
public:
    ...
    public:
        ...
        /**
         * @brief Constructor
         * @param[in] _n_p Number of sampling positions 采样位置数量
         * @param[in] _n_h Number of sampling orientations per position 每个位置的采样方向数
         * @param[in] _max_alpha Maximum angle of sampling positions  采样位置的最大角度
         * @param[in] _max_psi Maximum angle of sampling orientations 采样方向的最大角度
         */
