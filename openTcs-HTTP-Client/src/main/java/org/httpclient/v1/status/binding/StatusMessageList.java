 ...
 */
package org.httpclient.v1.status.binding;
...
public class StatusMessageList {
  ...
  private Instant timeStamp = Instant.now(); //Time stamp

  @JsonProperty(required = true)
  @JsonPropertyDescription("The status messages")
  private List<StatusMessage> statusMessages = new LinkedList<>(); // the content of StatusMessage includes sequenceNumber and creationTimeStamp
